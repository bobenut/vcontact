          ...
          <div slot="dialogBody">
            <div class='form-horizontal' role='form'>
              <div class='form-group'>
                  ...
                  <div class='col-sm-7'>
                    <input class='form-control' name='name' type='text' placeholder='Name' v-model="newContact.name" v-validate="{ rules: { required: true, min: 2, max: 16 } }"/>
              ...
              <div class='form-group'>
                  ...
                  <div class='col-sm-7'>
                    <input class='form-control' name='nameFirstWordChr' type='text' placeholder='NameFirstWordChr' v-model="newContact.nameFirstWordChr" v-validate="{ rules: { required: true, min: 1, max: 1 } }"/>
              ...
              <div class='form-group'>
                  ...
                  <div class='col-sm-7'>
                    <input class='form-control' name='nameAllWordChr' type='text' placeholder='NameAllWordChr' v-model="newContact.nameAllWordChr" v-validate="{ rules: { required: true, min: 1, max: 10 } }"/>
              ...
              <div class='form-group'>
                  ...
                  <div class='col-sm-7'>
                    <input class='form-control' name='mobilePhone' type='text' placeholder='Mobile Phone' v-model="newContact.mobilePhone" v-validate="{ rules: { required: true, min: 4, max: 20 } }"/>
              ...
              <div class='form-group'>
                  ...
                  <div class='col-sm-7'>
                    <input class='form-control' name='mail' type='text' placeholder='Mail' v-model="newContact.mail" v-validate="{ rules: { required: true, email: true } }"/>
